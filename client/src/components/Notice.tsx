  ...
  return (
    <section className="mx-auto my-20 max-w-7xl space-y-4 p-4">
      ...
      <div className="flex items-center gap-4">
        <p className="basis-full text-lg">
          ...
          before use including but not limited to manufacturers recall and
          repair notices. Vehicle safety recall information may be researched at
          <a
          ...
          vehicle has not been repaired as part of a safety recall in the last
          15 years.
        </p>
      </div>
    </section>
